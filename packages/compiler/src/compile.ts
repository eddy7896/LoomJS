...
export function compile(snapshot: Snapshot): CompileResult {
  ...
  files.push({ path: 'src/App.tsx', content: emitApp(entry, routes, globals) });
...
function emitApp(entry: Artboard, routes: Map<string, RouteInfo>, globals: GlobalPlan[]): string {
